      ...
      <div className="w-full max-w-[400px] bg-white/80 backdrop-blur-md border border-white/60 shadow-[0_8px_30px_rgba(0,0,0,0.02),0_1px_3px_rgba(0,0,0,0.01)] rounded-2xl p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1">
            <label className="text-xs font-semibold text-slate-600 uppercase tracking-wider" htmlFor="name">
              Name
            </label>
            <input
              id="name"
        ...
        <p className="text-sm text-center text-slate-500 mt-6">
          ...
          <a href="/login" className="font-medium text-cyan-600 hover:text-cyan-500 transition-colors">
            Log In
          </a>
        </p>
      </div>
